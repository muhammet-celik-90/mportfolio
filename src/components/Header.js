            ...
            <div className="header-nav-area">
                <nav className="header-nav">
                    <li className='nav-item'>
                        ...
                        <span className='tooltiptext'>Anasayfa</span>
                    </li>
                    <li className='nav-item'>
                        <SiAboutdotme className='header-icon' />
                        <span className='tooltiptext'>Hakkımızda</span>
                    </li>
                    <li className='nav-item'>
                    ...
                    <li className='nav-item'>
                        ...
                        <span className='tooltiptext'>İşlerimiz</span>
                    </li>
                    <li className='nav-item'>
                        <FiPhoneCall className='header-icon' />
                        <span className='tooltiptext'>İletişim</span>
                    </li>
                </nav>
            </div>
        </div>
